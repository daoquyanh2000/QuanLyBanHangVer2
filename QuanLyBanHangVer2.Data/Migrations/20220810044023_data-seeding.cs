        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    OrderDate = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2022, 8, 10, 11, 40, 22, 652, DateTimeKind.Local).AddTicks(3333)),
                    UserId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("8d04dce2-969a-435d-bba4-df3f325983dc"), "648c10ec-3e88-4af2-8919-05895387b235", "Administrator role", "admin", "admin" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("69bd714f-9576-45ba-b5b7-f00649be00de"), 0, "d2c94e56-83e1-4fde-8749-ac5bec5ca60b", new DateTime(2020, 1, 31, 0, 0, 0, 0, DateTimeKind.Unspecified), "tedu.international@gmail.com", true, "Toan", "Bach", false, null, "tedu.international@gmail.com", "admin", "AQAAAAEAACcQAAAAEGBNYxLB9R48UcDOVZ2na2vlCfXsKRnqamUST096lLcyUCMxsCWglWbVqRF7u53ZmQ==", null, false, "", false, "admin" });

            migrationBuilder.InsertData(
                table: "Categories",
                columns: new[] { "Id", "IsShowOnHome", "ModifiedDate", "ParentId", "PassivedDate", "SortOrder", "Status" },
                values: new object[,]
                {
                    { 1, true, null, null, null, 1, 1 },
                    { 2, true, null, null, null, 2, 1 }
                });
            ...
            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "Id", "ModifiedDate", "OriginalPrice", "PassivedDate", "Price", "SeoAlias", "Status" },
                values: new object[] { 1, null, 100000m, null, 200000m, null, 1 });
